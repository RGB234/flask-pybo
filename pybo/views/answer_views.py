...
def create(question_id):
    ...
    if form.validate_on_submit():
        # <textarea name="content" id="content" row='15'></textarea> 에서 textarea  태그네임이 content
        content = request.form['content']
        answer = Answer(content=content, create_date=datetime.now(), user=g.user)
        # pybo.models.py
        # question = db.relationship('Question', backref=db.backref('answer_set', cascade='all, delete-orphan')) 에서 backref 'answer_set'
